 ...
 */
gulp.task( 'base', [ 'images:move', 'assets:move', 'scss:build', 'webpack:build' ] );  //, 'build:pug'
 ...
 */
gulp.task( 'build', [ 'images:move',  "pug:build" , 'scss:build' , 'assets:move', 'webpack:build', 'cms:cut' ] );  //, 'build:pug'


/* 
*   For dvelopment, Browser Sync
*/
gulp.task( 'dev', [  "pug:build" , 'scss:build' , 'images:move', 'webpack:build', 'browserSync'], function( ) {

    gulp.watch([ './src/view/**/*.pug',  './src/view/**/*.json'], ['pug:build'] );
    gulp.watch(['./src/scss/**/*.scss', './src/view/**/*.scss'], ['scss:build'] );

    gulp.watch(['./src/assets/images/**/*'], ['images:move'] );
